...
if __name__ == "__main__":
    main_cat(numTrainEpisodes=200,numJitterTest=10,numTestEpisodes=10,numRepititions=32,save_iterations=10,numSmoothTests=2)
    main_DQN(numTrainEpisodes=200,numJitterTest=10,numTestEpisodes=10,numRepititions=32,save_iterations=10,numSmoothTests=2)
